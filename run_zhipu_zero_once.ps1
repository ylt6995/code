...
$log = Join-Path (Get-Location) ("run_zhipu_zero_once_" + $ts + ".log")

python -u run_llm_bidrig_experiment.py --providers zhipu --methods zero --prompt-seeds 0 2>&1 | Tee-Object -FilePath $log
