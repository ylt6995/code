...
$log = Join-Path (Get-Location) ("run_zhipu_cot_once_" + $ts + ".log")

python -u run_llm_bidrig_experiment.py --providers zhipu --methods cot --prompt-seeds 0 2>&1 | Tee-Object -FilePath $log
